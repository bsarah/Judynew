...
module Data.Judy (
    ...
    -- * Construction
    , Data.Judy.new
    , Data.Judy.reallyUnsafeRunFinalizer
...
reallyUnsafeRunFinalizer :: JudyL a -> IO ()
reallyUnsafeRunFinalizer j = (takeMVar $ unJudyL j) >>= finalizeForeignPtr
{-# INLINE reallyUnsafeRunFinalizer #-}
